...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        SimpleOomage c = (SimpleOomage) o;

        return Integer.compare(c.red, red) == 0 && Integer.compare(c.green, green) == 0
                && Integer.compare(c.blue, blue) == 0;
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            double ret = red * 10e6 + green * 10e3 + blue;
            return (int) ret;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        SimpleOomage ooA2 = new SimpleOomage(0, 210, 255);
